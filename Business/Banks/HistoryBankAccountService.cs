namespace Business.Banks
{
    ...
    public class HistoryBankAccountService : BaseService<HistoryBankAccount>
    {
        ...
        public HistoryBankAccountService(HistoryBankAccountModel model, IMapper mapper, IHttpContextAccessor httpContext, BaseStoreProcedureModel spModel) : base(model, mapper, httpContext, spModel)
        {
