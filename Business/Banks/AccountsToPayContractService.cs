namespace Business.Banks
{
    ...
    public class AccountsToPayContractService : BaseService<AccountsToPayContract>
    {
        ...
        public AccountsToPayContractService(AccountsToPayContractModel model, IMapper mapper, IHttpContextAccessor httpContext, BaseStoreProcedureModel spModel) : base(model, mapper, httpContext, spModel)
        {
