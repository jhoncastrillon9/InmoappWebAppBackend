namespace Business.Banks
{
    ...
    /// </summary>
    public class BankAccountService : BaseService<BankAccountDTO>
    {
        /// <summary>
        ...
        public BankAccountService(IConfiguration config, string con) : base(new BankAccountModel(config, con))
        {
